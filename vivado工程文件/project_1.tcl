...
#
# Generated by Vivado on Thu May 21 21:34:31 +0800 2026
...
#
#    "C:/Users/19916/Desktop/hdlcoder_test/hdl_coder_vivado_2/project_1/project_1.srcs/sources_1/imports/design_1_wrapper.v"
#
...
proc checkRequiredFiles { origin_dir} {
  ...
  set paths [list \
   [file normalize "$origin_dir/hdlcoder_test/test4/codegen/ipcore/img_threshold_fixpt_ipcore_v1_0"] \
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/hdlcoder_test/hdl_coder_vivado_2/project_1"]"
...
set_property -name "compxlib.modelsim_compiled_library_dir" -value "C:/Users/D_SoftWare/Vivado/Library" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/hdlcoder_test/test4/codegen/ipcore/img_threshold_fixpt_ipcore_v1_0"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/hdlcoder_test/hdl_coder_vivado_2/project_1/project_1.srcs/sources_1/imports/design_1_wrapper.v"]\
]
...
proc cr_bd_design_1 { parentCell } {
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  xilinx.com:ip:img_threshold_fixpt_ipcore:1.0\
  ...
  # Create instance: img_threshold_fixpt_0, and set properties
  set img_threshold_fixpt_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:img_threshold_fixpt_ipcore:1.0 img_threshold_fixpt_0 ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins img_threshold_fixpt_0/AXI4_Lite] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins img_threshold_fixpt_0/AXI4_Lite_ARESETN] [get_bd_pins img_threshold_fixpt_0/IPCORE_RESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_96M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins img_threshold_fixpt_0/AXI4_Lite_ACLK] [get_bd_pins img_threshold_fixpt_0/IPCORE_CLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_96M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs img_threshold_fixpt_0/AXI4_Lite/reg0] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.1594",
   "Default View_TopLeft":"0,-7",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 340 -y 340 -defaultsOSRD
preplace inst img_threshold_fixpt_0 -pg 1 -lvl 1 -x 340 -y 160 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 3 -x 1160 -y 290 -defaultsOSRD
preplace inst rst_ps8_0_96M -pg 1 -lvl 2 -x 830 -y 330 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 40 60 640 220 1000
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 1 1 650 310n
preplace netloc rst_ps8_0_96M_peripheral_aresetn 1 0 3 30 50 NJ 50 1010
preplace netloc ps8_0_axi_periph_M00_AXI 1 0 4 20 40 NJ 40 NJ 40 1300
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 1 2 630J 230 N
levelinfo -pg 1 0 340 830 1160 1330
pagesize -pg 1 -db -bbox -sgen 0 0 1330 670
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/hdlcoder_test/hdl_coder_vivado/hdl_coder_vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "E:/Study/VITIS_DEMO/ps_hello/vivado/ps_hello.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "E:/Study/VITIS_DEMO/ps_hello/vivado/ps_hello.srcs/utils_1/imports/impl_1" -objects $obj
