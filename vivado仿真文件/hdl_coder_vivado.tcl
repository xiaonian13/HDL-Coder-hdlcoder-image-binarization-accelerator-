...
#
# hdl_coder_vivado.tcl: Tcl script for re-creating project 'hdl_coder_vivado'
#
# Generated by Vivado on Thu May 21 21:31:00 +0800 2026
...
#
# 1. This project restoration tcl script (hdl_coder_vivado.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/19916/Desktop/hdlcoder_test/hdl_coder_vivado/hdl_coder_vivado.srcs/sim_1/new/tb_top.sv"
#
...
proc checkRequiredFiles { origin_dir} {
  ...
  set paths [list \
   [file normalize "$origin_dir/hdlcoder_test/test4/codegen/ipcore"] \
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "hdl_coder_vivado"
...
set script_file "hdl_coder_vivado.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/hdlcoder_test/hdl_coder_vivado"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/hdlcoder_test/test4/codegen/ipcore"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/hdlcoder_test/hdl_coder_vivado/hdl_coder_vivado.srcs/sim_1/new/tb_top.sv" ]\
]
...
proc cr_bd_design_1 { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.PULSE_PERIOD {200} \
   CONFIG.RST_PERIOD {200} \
   CONFIG.RST_POLARITY {ACTIVE_LOW} \
 ] $sim_rst_gen_0

  # Create interface connections
  connect_bd_intf_net -intf_net axi_vip_0_M_AXI [get_bd_intf_pins axi_vip_0/M_AXI] [get_bd_intf_pins img_threshold_fixpt_0/AXI4_Lite]

  # Create port connections
  connect_bd_net -net sim_clk_gen_0_clk [get_bd_pins axi_vip_0/aclk] [get_bd_pins img_threshold_fixpt_0/AXI4_Lite_ACLK] [get_bd_pins img_threshold_fixpt_0/IPCORE_CLK] [get_bd_pins sim_clk_gen_0/clk]
  connect_bd_net -net sim_rst_gen_0_rst [get_bd_pins axi_vip_0/aresetn] [get_bd_pins img_threshold_fixpt_0/AXI4_Lite_ARESETN] [get_bd_pins img_threshold_fixpt_0/IPCORE_RESETN] [get_bd_pins sim_rst_gen_0/rst]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs img_threshold_fixpt_0/AXI4_Lite/reg0] -force
